...
public class CircularBarRange extends View {
    ...
    public CircularBarRange(Context context) {
        this(context, null);
    }

    public CircularBarRange(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircularBarRange(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CircularBarRange(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
